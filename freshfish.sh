...
# Function to generate a fake fish history file
generate_fake_history() {
    > "$HISTORY_FILE" # Clear the existing fish_history file
    echo
    echo -e "${WHITE}Generating fake${RESET} ${RED}fish_history${RESET} ${WHITE}file...${RESET}"
    echo -e "${WHITE}==========================================================${resets}"
    total_commands=100
    ...
    for i in $(seq 1 $total_commands); do
        ...
        # Add a fake entry in the Fish shell history format
    ...
    echo -e "\n${WHITE}==========================================================${RESET}"
    echo -e "${WHITE}Fake ${RED}fish_history${RESET} ${WHITE}file created at:${RESET} \n${PURPLEB}$HISTORY_FILE${RESET}"
    echo 
}
